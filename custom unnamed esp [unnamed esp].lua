--ORIGINAL: 
--https://github.com/ic3w0lf22/Unnamed-ESP/blob/master/UnnamedESP.lua
...
local Modules = {
	...
	[narutogameid] = { -- Ni2 shit
		CustomPlayerTag = function(Player)
			...
			if Character then
				--table.insert(Extra, "["..string.split(Character.Effects.DisplayName.Value, " ")[#string.split(Character.Effects.DisplayName.Value, " ")].."]");
				table.insert(Extra, Character.Effects.DisplayName.Value);
				table.insert(Extra, "SP: ["..tostring(Character.Effects.Rank.Value).."] ".."Chakra: ["..tostring(math.round(Character.Effects.Chakra.Value)).."/"..tostring(math.round(Character.Effects.Chakra.MaxValue)).."]");
			end
